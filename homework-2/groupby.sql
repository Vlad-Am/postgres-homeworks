...
SELECT order_id, customer_id, freight, ship_country FROM orders WHERE ship_city LIKE 'P%'
...
SELECT ship_country, SUM(freight) FROM orders WHERE ship_region IS NOT NULL
